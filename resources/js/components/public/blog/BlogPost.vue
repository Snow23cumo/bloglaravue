              ...
              <div class="row">
                <div class="span8">
                  <div class="post-image">
                    ...
                    <img :src="`uploadimage/${post.photo}`" alt="" width="300px" height="200px"/>
                  </div>
                  ...
                  <div class="bottom-article">
                    ...
                    <router-link :to="`blogpostsingle/${post.id}`" class="pull-right">Continue reading <i class="icon-angle-right"></i></router-link>
                  </div>
                </div>
              </div>
            </article>
